...
"[project]/lib/supabase/chat.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getConversations(userId) {
    const { data: conversations, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("conversations").select(`
      *,
      creator:creator_id(*),
    ...
    const conversationsWithDetails = await Promise.all(conversations.map(async (conv)=>{
        const { data: lastMessage } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("messages").select("*").eq("conversation_id", conv.id).order("created_at", {
            ascending: false
        }).limit(1).single();
...
async function getOrCreateConversation(userId, participantId) {
    ...
    const { data: existingConversation, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("conversations").select("*").or(`and(creator_id.eq.${userId},participant_id.eq.${participantId}),and(creator_id.eq.${participantId},participant_id.eq.${userId})`).single();
    if (!fetchError && existingConversation) {
        return existingConversation;
    }
    // Create new conversation
    const { data: newConversation, error: createError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("conversations").insert([
        {
            creator_id: userId,
...
async function getMessages(conversationId) {
    const { data: messages, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("messages").select(`
      *,
...
async function sendMessage(conversationId, senderId, text) {
    const { data: message, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("messages").insert([
        {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("conversations").update({
...
function subscribeToMessages(conversationId, callback) {
    ...
    const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel(`messages-${conversationId}`);
...
async function getAllUsers(currentUserId) {
    const { data: users, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").select("*").neq("id", currentUserId);
    if (error) throw error;
    return users;
}
async function getUserById(userId) {
    const { data: user, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").select("*").eq("id", userId).single();
    if (error) throw error;
    return user;
}
async function updateUserStatus(userId, status) {
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").update({
        status
    }).eq("id", userId);
    if (error) throw error;
}
function startTyping(conversationId, userId) {
    const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel(`typing-${conversationId}`);
    channel.subscribe();
    channel.track({
        user_id: userId,
        is_typing: true
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/chat.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/client.ts [app-client] (ecmascript)");
;
...
function ChatWindow({ chatId, currentUserId }) {
    ...
    const [typingChannel, setTypingChannel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        "ChatWindow.useEffect": ()=>{
            ...
            const loadMessages = {
                "ChatWindow.useEffect.loadMessages": async ()=>{
                    try {
                        setIsLoading(true);
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMessages"])(chatId);
                        setMessages(data);
                    } catch (error) {
            ...
            const loadCurrentUser = {
                "ChatWindow.useEffect.loadCurrentUser": async ()=>{
                    try {
                        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserById"])(currentUserId);
                        setCurrentUser(user);
                    } catch (err) {
                    // ignore, optional
                    }
                }
            }["ChatWindow.useEffect.loadCurrentUser"];
            loadMessages();
            loadCurrentUser();
            // Subscribe to real-time messages
            const subscription = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToMessages"])(chatId, {
                "ChatWindow.useEffect.subscription": (newMessage)=>{
                    setMessages({
                        "ChatWindow.useEffect.subscription": (prev)=>{
                            // Avoid duplicates if message already exists (optimistic or already added)
                            if (prev.some({
                                "ChatWindow.useEffect.subscription": (m)=>m.id === newMessage.id
                            }["ChatWindow.useEffect.subscription"])) return prev;
                            return [
                                ...prev,
                                newMessage
                            ];
                        }
                    }["ChatWindow.useEffect.subscription"]);
                }
            }["ChatWindow.useEffect.subscription"]);
            // Subscribe to typing indicators
            const typingSub = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToTyping"])(chatId, {
                "ChatWindow.useEffect.typingSub": (users)=>{
                    setTypingUsers(users.filter({
                        "ChatWindow.useEffect.typingSub": (id)=>id !== currentUserId
                    }["ChatWindow.useEffect.typingSub"]));
                }
            }["ChatWindow.useEffect.typingSub"]);
    ...
    const handleSendMessage = async ()=>{
        ...
        if (typingChannel) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stopTyping"])(typingChannel);
        }
        try {
            ...
            const sent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendMessage"])(chatId, currentUserId, messageText);
    ...
    const handleInputChange = (e)=>{
        ...
        // Start typing
        if (typingChannel) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$chat$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startTyping"])(chatId, currentUserId);
        }
...
_s(ChatWindow, "F/qPIJl9nYXFa5Y7gG9wKnZTxhM=");
_c = ChatWindow;
var _c;
...
function ChatPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chat$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(ChatPage, "kMLKGS/WW03jt3GNddJWeETi4h4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
//# sourceMappingURL=_8aa3e31f._.js.map